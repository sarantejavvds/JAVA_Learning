...
public class To_Replace_Existing_Elements_from_ArrayList 
{

	public To_Replace_Existing_Elements_from_ArrayList() 
	{
	...
	public static void main(String[] args) 
	{
		...
		animals_list.set(0, "Asian Dog");
		
		animals_list.set(3, "Black Cobra");
