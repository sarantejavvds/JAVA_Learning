 ...
 * 
 * The CRUD operations are used at Basic Level in this project and only on a Single Table.
 * 
 * **/
...
public class Performs_CRUD_on_Gaming_Table  
{
	...
	public static void main(String[] args) throws SQLException 
	{
		...
		try
		{
			SSMS_Connection.get_Connection(); // Trying to establish the connection Immediately.
		}
		catch(Exception e)
		{
